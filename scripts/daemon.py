...
def setup_client(client):
    ...
    if behavior == 'ping':
        ...
        behavior_command = 'python selenium-browsing-automation/scripts/streaming/youtube_selenium.py'
    elif behaviour == 'browsing':
        behavior_command = 'python selenium-browsing-automation/scripts/browsing/endless-scroll.py' 
